...
# ── Identity & SSO (OIDC) ───────────────────────────────────────────────────
variable "issuer_url" {
  description = "The OIDC issuer URL (Authentik)"
  type        = string
  default     = ""
}
...
variable "headlamp_client_id" {
  description = "The OIDC client ID for Headlamp"
  type        = string
  default     = ""
}

variable "headlamp_client_secret" {
  description = "The OIDC client secret for Headlamp"
  type        = string
  sensitive   = true
  default     = ""
}
