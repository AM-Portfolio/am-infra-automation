...
module "identity" {
  ...
  authentik_secret_key = local.creds.authentik_bootstrap
...
output "auth_flow_id" { value = module.identity.auth_flow_id }
output "invalidation_flow_id" { value = module.identity.invalidation_flow_id }
output "certificate_key_id" { value = module.identity.certificate_key_id }
output "property_mappings" { value = module.identity.property_mappings }
output "infra_admins_group_id" { value = module.identity.infra_admins_group_id }
