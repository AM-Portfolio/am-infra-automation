...
# Also seed Secret vault-unseal-keys from that host's vault-dr-infra.json.
# Apply kind-fleet/dr/exposer (Docker DNS am-dr-infra-control-plane) — never bake Kind IP.
